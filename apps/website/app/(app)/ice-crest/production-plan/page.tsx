    ...
    <div className="space-y-5">
      <div className="flex flex-wrap items-end justify-between gap-3">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <label className="text-sm">Safety stock / SKU<input type="number" min="0" value={safety} onChange={e => setSafety(e.target.value)} className="ml-2 w-20 rounded border px-2 py-2" /></label>
        </div>
      </div>
