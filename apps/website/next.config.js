...
const csp = [
  ...
  "connect-src 'self' https://api.smebuze.com https://api.razorpay.com https://lumberjack.razorpay.com https://checkout.razorpay.com https://api-preprod.phonepe.com https://api.phonepe.com https://*.phonepe.com http://localhost:3000 ws://localhost:3001 http://localhost:3001",
  "font-src 'self' data:",
  "object-src 'none'",
  "base-uri 'self'",
  "form-action 'self' https://*.phonepe.com https://mercury.phonepe.com https://mercury-uat.phonepe.com",
